...
/**
 * Creates all permission-related tables required by the Spatie Laravel Permission package.
 *
 * This migration sets up the following tables:
 * - permissions: stores all available permissions
 * - roles: stores all available roles
 * - model_has_permissions: pivot table linking permissions to models (e.g. users)
 * - model_has_roles: pivot table linking roles to models (e.g. users)
 * - role_has_permissions: pivot table linking permissions to roles
 *
 * Configuration is read from config/permission.php.
 * Supports optional team-based permissions via the 'teams' config option.
 */
